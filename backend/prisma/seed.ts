  ...
  const products = await Promise.all([
    ...
    prisma.product.create({
      data: {
        ...
        categoryId: 'cat-1',
        description: "Fabriquee a la main par nos maitres artisans, cette bague incarne le summum du raffinement Satouba Bijouterie 255. Diamant etincelant certifie serti sur de l'or jaune pur 18 carats, monture en pave pour une luminosite maximale.",
        price: 450000,
    ...
    prisma.product.create({
      data: {
        ...
        categoryId: 'cat-3',
        description: "Le bracelet tennis revisite par Satouba Bijouterie 255. Diamants taille brillant uniformes serti sur un bracelet souple en or blanc 18K. Fermoir a clip securise.",
        price: 520000,
  ...
  await Promise.all([
    ...
    prisma.notification.create({
      data: {
        ...
        title: 'Bienvenue',
        message: 'Bienvenue chez Satouba Bijouterie 255 !',
