...
('ss-2', 'tagline', 'L''excellence de la joaillerie senegalaise', 'Slogan'),
('ss-3', 'whatsapp', '221055413074', 'Numero WhatsApp'),
('ss-4', 'phone_main', '+221 05 541 30 74', 'Telephone principal'),
('ss-5', 'email', 'contact@satouba-bijouterie.sn', 'Email contact'),
('ss-6', 'address', 'Avenue Bourguiba, Dakar, Senegal', 'Adresse atelier'),
