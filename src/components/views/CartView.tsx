          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-[#EAF7ED] p-4 rounded-2xl border border-[#0B5D1E]/20 flex items-center gap-3">
              ...
              <p className="text-xs text-[#064A15] leading-relaxed">
                Paiement <strong>Wave</strong> — montant verrouillé. <strong>Coursier SaTouba (Abidjan & environs) Gratuit</strong> — Remise en main propre sous 24-48h avec certificat d’authenticité.
              </p>
            </div>
          </div>
