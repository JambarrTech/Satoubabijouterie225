        ...
        >
          ...
          >
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <h1 className="font-serif text-2xl font-bold text-white">Espace Gérant</h1>
            </div>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className={`relative rounded-xl border transition-all duration-200 ${focused === 'email' ? 'border-[#0B5D1E] ring-2 ring-[#0B5D1E]/10' : 'border-gray-200'}`}>
                <Mail size={18} className={`absolute left-3 top-1/2 -translate-y-1/2 transition-colors ${focused === 'email' ? 'text-[#0B5D1E]' : 'text-gray-400'}`} />
                <input
                  type="email"
                  value={email}
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-xl text-sm focus:outline-none bg-transparent"
                  placeholder="admin@satouba.com"
                  required
                />
              </div>
            </div>
